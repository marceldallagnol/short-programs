/**
* P5RegPentaPrism.java
* This class extends P5Pentagon, and therefore has one (non-final) instance
* variable, its side, apart from its height. It represents a prism with a
* regular pentagon for a base.
**/
public class P5RegPentaPrism extends P5RegPentagon
{
   ...
   public P5RegPentaPrism(){height = 1.0;}

   /*This constructor initializes the side of the prism to s, and
     height to h*/
   public P5RegPentaPrism(double s, double h)
   {
      side = s;
      height = h;
   }

   /*This method sets the side of the base pentagon to the argument dim1,
   ...
   public String toString(){return(this.getName() + side + " x " + height);}
